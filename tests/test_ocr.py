...
class TestOcrBackends(unittest.TestCase):
    ...
    def test_ingest_of_a_scanned_pdf_end_to_end(self):
        ...
        note = vault_dir / "Documents/Invoices/2024/2024-05-02 Acme Invoice INV-1234.md"
        attachment = vault_dir / "Attachments/Invoices/2024/2024-05-02 Acme Invoice INV-1234.pdf"
